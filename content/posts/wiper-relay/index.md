...
Recently, the wipers have started to play up on my [2010 BMW E60 LCI](https://en.wikipedia.org/wiki/BMW_5_Series_(E60)#2007_facelift).

I booked it in to [North Oxford BMW](http://www.oxfordbmw.co.uk/) last Saturday morning, as it'd been there for services and I'm happy with the work and the customer care.
...
<figure>
{{ image(url="bmw_1.jpg", url_min="bmw_1.jpg", alt="Engine bay") }}
...
<figure>
{{ image(url="bmw_2.jpg", url_min="bmw_2.jpg", alt="Top of the e-box") }}
...
<figure>
{{ image(url="bmw_3.jpg", url_min="bmw_3.jpg", alt="Location of the e-box") }}
{{ image(url="bmw_4.jpg", url_min="bmw_4.jpg", alt="Inside the e-box") }}
